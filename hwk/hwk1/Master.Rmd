...
graphic and the by-hand calculations. `Optim` requires 31 to solve both optimization problems.  

```{r, echo = TRUE, eval = TRUE}

optim(par = 0.2, my_function, lower = -0.5, upper = 2.5, method = 'L-BFGS-B')
optim(par = 1.8, my_function, lower = -0.5, upper = 2.5, method = 'L-BFGS-B',
