...
head(cor_data)
# ATTENTION:
# there is an ordering issue when i calculate the correlations
# i've checked my calculations all the way before the correlation calculation and they match Chris's - not able to figure it out
```
