...
put all of the commands in quote and then eval in parent frame in swap.eval
do multiple times and save the times
...
# env bash command
# last 3 weeks of class group topic presentation
# dotc versus .cpp
