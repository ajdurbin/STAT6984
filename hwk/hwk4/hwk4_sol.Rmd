...
Our code using the `boot` library is as follows. We need to define a 'statistic' in the `boot` in order to get the regression coefficients from the bootstrap samples. We use the same plot statement as above to compare the bootrap samples. 
